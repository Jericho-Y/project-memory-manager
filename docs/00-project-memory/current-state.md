...
- A local skill evolution automation can periodically review `pmm` for upgrade opportunities and write read-only roadmap reports under `.project-runtime/skill-evolution/`; it must not edit, commit, push, release, activate workflows, or change GitHub state.
