...
Maintain `pmm` v0.2.0 as a low-context, cross-agent project runtime with Self-Eval Loop, Core Pack templates, adapter templates, and synchronized public documentation.
...
- Public GitHub Release notes focus on user-visible changes and upgrade notes; routine verification command lists stay in internal release records.
...
- The `v0.1.0` and `v0.2.0` GitHub Release titles and notes were updated after publication to use the formal project name, native Chinese primary copy, collapsible English mirrors, and public change-log style content without routine internal verification logs.
