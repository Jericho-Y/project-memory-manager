...
- Updated the `v0.2.0` GitHub Release notes to Chinese-first bilingual notes and added a release checklist rule requiring future GitHub Releases to keep Chinese and English content in sync.
